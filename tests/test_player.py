...
@pytest.mark.parametrize(("test_user_id", "expected_len_min"), ((1070215, 40),))
...
@pytest.mark.parametrize(("test_username", "expected"), (("Serene-Arc", 1070215),))
